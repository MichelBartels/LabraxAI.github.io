function GAN(epoch_callback) {
    ...
    new MNIST(function (MNIST_DATASET) {
        ...
        setInterval(function() {
            ...
            let generator_y = generator_output(generator_add2(generator_matmul2(generator_layer_2_y, generator_w3.array), generator_b3.array));
            ...
            generator_y = generator_output(generator_add2(generator_matmul2(generator_layer_2_y, generator_w3.array), generator_b3.array));
            ...
            let generator_slope_layer_2_ = generator_slope_layer_2(generator_layer_1_y_no_activation);
            ...
            let generator_w3_transpose_ = new Matrix(generator_w3.array, 128, 784).transpose_matrix;
            ...
            let generator_w3_adjustments_ = generator_w3_adjustments(generator_layer_2_y_transpose_.array, generator_derivative_output_layer_);
            ...
            let generator_w1_adjustments_ = generator_w2_adjustments(generator_noise_transpose_.array, generator_derivative_layer_1_);
            let generator_b1_adjustments_ = generator_b2_adjustments(generator_derivative_layer_1_);
            let generator_w1_adjustments_learning_rate_ = generator_w2_adjustments_learning_rate(generator_w1_adjustments_);
            let generator_b1_adjustments_learning_rate_ = generator_b2_adjustments_learning_rate(generator_b1_adjustments_);
